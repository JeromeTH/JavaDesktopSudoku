...
public class GameLogic {
    ...
    private static boolean squaresAreInvalid(int[][] grid){
        if(rowOfSquaresIfInvalid(Rows.TOP, grid)) return true;
        if(rowOfSquaresIfInvalid(Rows.MIDDLE, grid)) return true;
        if(rowOfSquaresIfInvalid(Rows.BOTTOM, grid)) return true;
        return false;
    }
    ...
    private static boolean rowOfSquaresIfInvalid(Rows value, int[][] grid){
        switch(value){
            case TOP:
